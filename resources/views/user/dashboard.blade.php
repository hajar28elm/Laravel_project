                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="{{$i}}s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <a class="btn btn-primary  px-5 mt-2" href="{{ route('course.details', ['id' => $item->id]) }}">Read More</a>
                            &nbsp &nbsp &nbsp
                            <div id="notifDiv">
                            @php $countWishlist =0 @endphp
                              @if(Auth::check())
                              @php
                              $countWishlist = App\Models\Wishlist::countWishlist($item['id'])
                              @endphp
                              @endif
                               <a href="#" data-courseid="{{ $item->id}}" class="update_wishlist">
