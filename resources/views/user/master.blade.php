        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="/user/about" class="nav-item nav-link">About us</a>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="{{route('dashboard.categories',$item->id)}}" class="dropdown-item">{{ $item->name}}</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="{{route('dashboard.tests')}}" class="dropdown-item">Tests</a>
                            <a href="{{route('dashboard.user.stories')}}" class="dropdown-item">Learners Stories</a>
                        </div>
                    </div>
                    <a href="{{ route('contact.index') }}" class="nav-item nav-link">Contact us</a>
                </div>
               </div>
               <a href="{{ route('dashboard.user.wishlist') }}"> <i class="bi bi-heart-fill text-danger" style="font-size: 1.5em;"><span class="badge badge-danger total_wishlist text-danger"></span></i></a> &nbsp  &nbsp  &nbsp
               @php $countevent =0; $countreadevent=0 @endphp
               @if(Auth::check())
                @php
                $countevent = App\Models\Event::countEvent(); $countreadevent = App\Models\ReadEvent::countreadEvent()
                @endphp
                @endif
                @if($countevent > $countreadevent)
                 <a href="{{ route('dashboard.events') }}" class="notification-icon">
                   <span class="bi bi-bell-fill" style="font-size: 1.5em;"></span>
                   <span class="notification-dot"></span>
                </a>
                @else
                 <a href="{{ route('dashboard.events') }}" class="bi bi-bell-fill" style="font-size: 1.5em;"></a> &nbsp
                @endif
               <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">{{ Auth::user()->name }}</a>
                        <div class="dropdown-menu m-0">
                            <a href="{{ route('dashboardprofile.index') }}" class="dropdown-item">Profil</a>
                            <a href="{{ route('dashboard.user.courses') }}" class="dropdown-item">My courses</a>
