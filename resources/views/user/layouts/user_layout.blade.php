                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="destination.html" class="dropdown-item">{{ $item->name}}</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="destination.html" class="dropdown-item">Forum</a>
                            <a href="booking.html" class="dropdown-item">Events</a>
                            <a href="team.html" class="dropdown-item">Learners Stories</a>
                        </div>
                    </div>
